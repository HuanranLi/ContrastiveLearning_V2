...
python SSL_main.py --run_name TransFusion-after_FNN_Info --projection_head TransFusion-after_FNN --num_TF_layers 5 --experiment_name TransFusion_MidTemp_ITER30 --max_epochs 15 --accelerator mps --LossTemperature 0.5 

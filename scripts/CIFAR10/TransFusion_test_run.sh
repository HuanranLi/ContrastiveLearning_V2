...
run_name=${projection_head}_Layer${num_TF_layers}_LR${learning_rate}


python SSL_main.py --learning_rate $learning_rate --run_name $run_name --projection_head $projection_head --num_TF_layers $num_TF_layers --experiment_name TransFusion_MidTemp_ITER30 --max_epochs 5 --accelerator mps --LossTemperature 0.5
